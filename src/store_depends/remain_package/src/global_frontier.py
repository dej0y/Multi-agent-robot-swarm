...
class FrontierMarkerPublisher:
    ...
    def publish_frontier_count(self, count):
        ...
        if count>5000 and self.flag_1==0 and self.flag_2==0: self.flag_1, self.flag_2 = 1, 0
        if count<1500 and self.flag_1==1 and self.flag_2==0: self.flag_1, self.flag_2 = 0, 1
        if self.flag_1==0 and self.flag_2==1: 
            rospy.loginfo("Initializing 'map_explored' node.")
            os.system("rosrun remain_package zombie_node.py &")
            self.flag_1, self.flag_2 = 1, 1
