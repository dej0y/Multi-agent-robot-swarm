...
class ActorCritic:
	def __init__(self, env, sess):
		...
		summary_writer = tf.compat.v1.summary.FileWriter('/home/drone/final/src/src/turtlebot_ddpg/scripts/fd_replay/play_human_data/Run')
...
def main():
	...
	num_trials = 1000000
	trial_len  = 500 
	train_indicator = 1  ## make this 0 for inference and 1 for training 
	...
	if (train_indicator==1):n
        ## use this to continue training from prevvious weights
		#actor_critic.actor_model.load_weights("actormodel-300-500.h5")     
		#actor_critic.critic_model.load_weights("criticmodel-300-500.h5")
		for i in range(num_trials):
			print("trial:" + str(i))
			#game_state.game_step(0.3, 0.2, 0.0)
			#game_state.reset()
