...
class GameState:
    ...
    def __init__(self):
        ...
        self.action_info = rospy.Subscriber("/bot1/cmd_vel", Twist, self.action_ig)
        ...
        self.state_num = 184 #685                 # when you change this value, remember to change the reset default function as well
        self.action_num = 2
