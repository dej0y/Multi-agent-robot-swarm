...
def main():
	...
	if train_indicator==0:
		for i in range(num_trials):
			...
			actor_critic.actor_model.load_weights("/home/drone/rl_train/src/turtlebot_ddpg/scripts/original_ddpg/actormodel-80-2000.h5")
			actor_critic.critic_model.load_weights("/home/drone/rl_train/src/turtlebot_ddpg/scripts/original_ddpg/criticmodel-80-2000.h5")
			##############################################################################################
			total_reward = 0
