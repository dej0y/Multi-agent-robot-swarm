...
class GameState:
    ...
    def __init__(self):
        ...
        self.laser_info = rospy.Subscriber("/bot1/scan", LaserScan, self.laser_ig)
    ...
    def reset(self):
        ...
        random_points = self.generate_random_points_in_polygon(polygon, num_points=1)
    ...
    def game_step(self, time_step=0.1, linear_x=0.8, angular_z=0.3):
        ...
        for i in range(len(normalized_laser)):
            if normalized_laser[i] == np.inf:
                ...
                normalized_laser[i] = normalized_laser[i]/3.5
